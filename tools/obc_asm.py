...
OPS = {
    ...
    "LOAD_ADDR_G": (0x16, 4), "LOAD_FLD_I": (0x23, 2), "LOAD_FLD_P": (0x25, 2), "STORE_FLD_P": (0x28, 2), "LOAD_CONST_P": (0x2C, 4), "ALLOC_NEW": (0x2A, 4), "STORE_FLD_I": (0x26, 2), "LOAD_IDX_I": (0x1D, 0), "STORE_IDX_I": (0x20, 0),
    "LOAD_CONST_R": (0x2D, 4),
